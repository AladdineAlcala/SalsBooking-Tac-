            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                   ...
                   // ReportContractFunction repcontractfunction = new ReportContractFunction();
                    ...
                    //cryRep.Database.Tables["SBOSysTac_ViewModel_BookMenusViewModel"].SetDataSource(conDetails);
                    //cryRep.Database.Tables["SBOSysTac_ViewModel_BookMenusViewModel"].SetDataSource(conBookMenus);
                    //cryRep.Database.Tables["SBOSysTac_Models_BookingAddon"].SetDataSource(addons);
